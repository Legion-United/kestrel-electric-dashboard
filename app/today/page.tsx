  ...
  return (
    <>
      <PageHead eyebrow={today.date} title="Good morning, Sam" sub={today.greeting}>
        ...
        <button className="btn primary"><Bolt /> Start the day</button>
      </PageHead>
      ...
      <div className="grid" style={{ gridTemplateColumns: "1.6fr 1fr", alignItems: "start" }}>
        {/* schedule */}
        <Card title="Today's run" sub={`${today.jobsToday} jobs · optimised route`} icon={<Route width={17} height={17} />} right={<button className="btn sm ghost">Full calendar</button>}>
            ...
            <div className="stack" style={{ gap: 12 }}>
              <div className="notice y">
                ...
                <div>
                  ...
                  <div className="row" style={{ gap: 8, marginTop: 9 }}>
                    <button className="btn sm primary">Book a call</button>
                    <button className="btn sm ghost">Snooze 7d</button>
                  </div>
                </div>
              </div>
              <div className="notice b">
                ...
                <div>
                  ...
                  <div className="row" style={{ gap: 8, marginTop: 9 }}>
                    <button className="btn sm primary">Approve follow-up</button>
        ...
        <Card title="Fresh enquiries" sub="Captured by the Receptionist" icon={<Phone width={17} height={17} />} right={<a className="tiny" style={{ color: "var(--cobalt)" }} href="/inbox">Open inbox →</a>}>
          <div className="stack" style={{ gap: 0 }}>
            {leads.slice(0, 3).map((l) => (
              <div key={l.id} className="spread" style={{ padding: "11px 0", borderBottom: "1px dashed var(--line)" }}>
                <div className="row" style={{ gap: 10 }}>
